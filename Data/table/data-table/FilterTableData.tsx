...
export const filterDataTableColumns = [
  ...
  {
    name: "position",
    selector: (row: deleteRowData) => row["position"],
    sortable: true,
    center: false,
  },
  {
    name: "office",
    selector: (row: deleteRowData) => row["office"],
    sortable: true,
    center: false,
  },
  {
    name: "age",
    selector: (row: deleteRowData) => row["age"],
    sortable: true,
    center: false,
  },
  {
    name: "Start Date",
    selector: (row: deleteRowData) => row["startDate"],
    sortable: true,
    center: false,
  },
  {
    name: "salary",
    selector: (row: deleteRowData) => row["salary"],
    sortable: true,
    center: false,
  },
];
