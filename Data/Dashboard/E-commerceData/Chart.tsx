...
export const OrderThisMonthChart: MonthlyProfitsChartData = {
  series: [
    {
      name: "Sales",
...
interface MonthlyProfitsChartData {
  series: number[] | { name: string; data: number[] }[];
  options: ApexOptions;
}
// Profit  Monthly //
export const MonthlyProfitsChartData: MonthlyProfitsChartData = {
  series: [30, 55, 35],
  options: {
...
interface OptionsOverView {
  series: { type: "area"; name: string; data: number[] }[];
  options: ApexOptions;
}
// Over Chart Option ///
export const OptionsOverView: OptionsOverView = {
  series: [
    {
      name: "Earning",
      type: "area",
...
export const OptionsOverViewBarChart: MonthlyProfitsChartData = {
  series: [
    {
      name: "Revenue",
      data: [
