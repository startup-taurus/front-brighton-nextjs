export const articalsData = [
  {
    ...
    icon: <i className="icofont icofont-read-book"></i>,
    class: "col-xl-4 xl-100 box-col-12",
    class2: "col-md-6 box-col-6 col-sm-6",
  },
  {
    id: 2,
    title: "Knowledgebase",
    ...
    icon: <i className="icofont icofont-idea"></i>,
  ...
  },
  {
    ...
    icon: <i className="icofont icofont-support"></i>,
    class: "col-xl-4 xl-50 col-md-6 box-col-6",
    class2: "box-col-12",
  },
];
