...
export const ACTION_PERMISSIONS: Record<string, Record<string, string>> = {
  Courses: {
    ...
    copy: PERMISSIONS.DUPLICATE_COURSE,
    block: PERMISSIONS.EDIT_COURSE,
  },
  Students: {
