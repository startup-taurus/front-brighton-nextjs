...
import { FullscreenText, Fullscreenbelow_sm, UXDesigner, WebDesign, WedDesigner } from 'utils/Constant';
...
const FullscreenBelowsm = () => {
    ...
    return (
        <Fragment>
            <Button color='outline-info-2x' type="button" onClick={() => { toggle() }} >{Fullscreenbelow_sm}</Button>
