...
import { FullscreenText, Fullscreenbelow_lg, UXDesigner, WebDesign, WedDesigner } from 'utils/Constant';
...
const BelowLg = () => {
    ...
    return (
        <Fragment>
            <Button color='outline-danger-2x' className="btn-outline-warning-2x" type="button" onClick={() => { toggle() }} >{Fullscreenbelow_lg}</Button>
