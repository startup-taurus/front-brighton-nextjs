...
import {FlatStyle,JointAddon,LeftAddon,LeftAndRightAddon,RaiseStyle,RightAddon,SolidStyle,} from "utils/Constant";

const VariationOfAddonsForms = () => {
  return (
    <form>
      ...
      <FormGroup>
        ...
        <InputGroup>
          <InputGroupText className="list-light-primary">
            <i className="icofont icofont-unlink txt-primary" />
          </InputGroupText>
      ...
      <FormGroup>
        ...
        <InputGroup className="mb-3">
          <InputGroupText className="list-light-danger">
            <i className="icofont icofont-ui-zoom-out txt-danger" />
          </InputGroupText>
          <Input type="text" />
          <InputGroupText className="list-light-danger">
            <i className="icofont icofont-ui-zoom-in txt-danger" />
          </InputGroupText>
        </InputGroup>
      </FormGroup>
      <FormGroup className="input-group-solid">
        ...
        <InputGroup>
          <InputGroupText className="list-light-primary">
            <i className="icofont icofont-users txt-primary" />
          </InputGroupText>
      ...
      <FormGroup className="input-group-square">
        ...
        <InputGroup>
          <InputGroupText className="list-light-danger">
            <i className="icofont icofont-credit-card txt-danger" />
          </InputGroupText>
          <Input type="text" />
        </InputGroup>
      </FormGroup>
      ...
      <div>
        ...
        <InputGroup className="pill-input-group">
          <InputGroupText className="list-light-danger">
            <i className="icofont icofont-ui-copy txt-danger" />
          </InputGroupText>
          <Input type="text" />
          <InputGroupText className="list-light-danger">
            <i className="icofont icofont-stock-search txt-danger" />
          </InputGroupText>
        </InputGroup>
      </div>
    </form>
...
export default VariationOfAddonsForms;
