    ...
    <div className="language-toggle d-flex justify-content-end mb-3">
      <Dropdown isOpen={dropdownOpen} toggle={toggle} direction="down">
        <DropdownToggle 
          ...
          innerRef={buttonRef}
        >
          <i className={`flag-icon flag-icon-${countryFlags[language as keyof typeof countryFlags]} px-2`}></i>
          <span className="me-2">{language === 'en' ? 'English' : 'Español'}</span>
        </DropdownToggle>
        <DropdownMenu style={{ width: buttonWidth ? `${buttonWidth}px` : '100%', minWidth: "100px" }}>
