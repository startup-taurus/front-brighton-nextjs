...
const GradebookTable = ({
  ...
  const canAddGrades = permissionSet ? permissionSet.has(PERMISSIONS.ADD_GRADES) : false;
  const canEditGrades = permissionSet ? permissionSet.has(PERMISSIONS.EDIT_GRADES) : false;
