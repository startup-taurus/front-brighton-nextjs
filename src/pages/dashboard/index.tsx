  ...
  useEffect(() => {
    if (access_denied) {
      ...
      switch (access_denied) {
        ...
        case 'professor':
          message =
            "You don't have access to view other professor's information";
          break;
      }
            ...
            <Row>
              {loading ? (
                <>
                  ...
                  <CardSkeleton colProps={{xxl: 12, md: 5}} height={380} />
                  <CardSkeleton colProps={{xxl: 12}} height={500} />
                </>
              ) : (
                <>
                  <SchoolData />
